...
class VerifyAccountScreen extends StatelessWidget {
  ...
  const VerifyAccountScreen({Key? key, required this.email,required this.password}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var size  = MediaQuery.sizeOf(context);
    return BlocProvider(create: (_)=>VerifyAccountCubit(),
              ...
              child: Container(
                ...
                Padding(
                  ...
                  child: CustomButton(
                    ...
                    isBuy: state is LoadingVerifyAccountStates,
                        onTap:(){
