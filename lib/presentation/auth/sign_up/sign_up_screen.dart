...
class SignUpScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(create: (_)=>RegisterCubit(),
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Text(tr(TextApp.registerAccount), style: headingStyle),
                        Text(tr(TextApp.appName), style: getBoldStyle(color: ColorManager.primary,fontSize: FontSize.s18)),

                        Text(
                          tr(TextApp.completeYourDetailsOrContinue),
